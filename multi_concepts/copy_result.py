...
if __name__ == "__main__":
    ...
    subjects = np.loadtxt(f"./data/PuzzleIOI/subjects_all.txt", dtype=str, delimiter=" ")[:, 1:]
    
    os.makedirs(f"./results/full_preview", exist_ok=True)
    for (subject, outfit) in tqdm(subjects):
        src_path = f"./data/PuzzleIOI_4views/puzzle_capture_full/{subject}/{outfit}/render/000.png"
