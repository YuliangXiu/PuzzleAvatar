...
python multi_concepts/train_multi.py \
  --pretrained_model_name_or_path $BASE_MODEL \
  --project_name ${SUBJECT_OUTFIT_LST} \
  --output_dir ${EXP_DIR} \
  --class_data_dir data/multi_concepts_data \
  --train_batch_size 1  \
  --phase1_train_steps 2000 \
  --phase2_train_steps 8000 \
  --lr_step_rules "1:4000,0.1" \
